...
@property (nonatomic,strong) NSArray *pImgArrLoop;
...
- (id)initWithProgressImages:(NSArray *)progressImg LoadingImages:(NSArray *)loadingImages ProgressScrollThreshold:(NSInteger)threshold LoadingImagesFrameRate:(NSInteger)lFrameRate {
    return [self initWithProgressImages:progressImg LoadingImages:loadingImages LoopImages:nil ProgressScrollThreshold:threshold LoadingImagesFrameRate:lFrameRate];
}
...
- (void)_commonInit
{
    ...
    if(self.pImgArrLoading==nil)
    ...
    else
     {
        ...
        self.imageViewLoading = [[UIImageView alloc] init];
